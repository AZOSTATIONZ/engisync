...
import { VerificationQueue } from "../../../budget/[id]/finance-ui";
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-4">
        ...
        <Link href={`/dashboard/workspaces/${id}`} className="rounded-lg border p-3 transition-colors hover:bg-accent">
      ...
      <Card>
        ...
        <CardContent className="flex flex-wrap gap-2">
          ...
          <Button asChild variant="outline" size="sm">
            <Link href={`/dashboard/workspaces/${id}/documentation`}>Review documentation</Link>
          </Button>
          <Button asChild variant="outline" size="sm">
