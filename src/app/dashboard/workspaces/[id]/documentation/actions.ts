...
export async function saveSection(
  ...
  revalidatePath(`/dashboard/workspaces/${workspaceId}/documentation`);
...
export async function addSectionComment(
  ...
  revalidatePath(`/dashboard/workspaces/${wsId}/documentation`);
  ...
  await Promise.all(
    leaders.map((l) =>
      createNotification({
        ...
        title,
        body,
        link: `/dashboard/workspaces/${workspaceId}/documentation`,
      }),
    ),
  );
}
  ...
  await Promise.all(
    leaders.map((l) =>
      createNotification({
        ...
        link: `/dashboard/workspaces/${wsId}/documentation`,
      }),
    ),
  );
