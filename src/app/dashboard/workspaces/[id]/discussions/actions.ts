...
export async function createThread(
  ...
  revalidatePath(`/dashboard/workspaces/${workspaceId}/discussions`);
  redirect(`/dashboard/workspaces/${workspaceId}/discussions/${thread.id}`);
}
...
export async function postMessage(
  ...
  if (thread.authorId !== user.id) {
    await createNotification({
      ...
      link: `/dashboard/workspaces/${thread.workspaceId}/discussions/${threadId}`,
    });
  }

  revalidatePath(`/dashboard/workspaces/${thread.workspaceId}/discussions/${threadId}`);
...
export async function deleteThread(threadId: string): Promise<DiscussionState> {
  ...
  revalidatePath(`/dashboard/workspaces/${thread.workspaceId}/discussions`);
  redirect(`/dashboard/workspaces/${thread.workspaceId}/discussions`);
}
