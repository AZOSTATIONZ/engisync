...
import { Target, Flag, AlertTriangle, Package, MessageSquare, Route, Archive } from "lucide-react";
...
import { TargetDateForm } from "@/app/dashboard/projects/projects-ui";
import {
  Card,
  CardContent,
  CardHeader,
...
import {
  ...
  RiskManager,
  DeliverableManager,
} from "@/app/dashboard/projects/projects-ui";
...
export default async function ProjectDetailPage({
  ...
  return (
    <div className="space-y-6">
      {/* The project name, department, stage and pace live in the shared
          project layout, so every tab shows them identically. */}
            ...
            <>
              ...
              {project.isLeader ? (
                ...
                <p className="text-xs text-muted-foreground">
                  Your project leader submits the publication.
                </p>
              )}
            </>
          )}
